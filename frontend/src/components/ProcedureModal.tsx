...
export default function ProcedureModal() {
  const { selectedProcedure, clearSelectedProcedure } = useToothStore();
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <div
        className="bg-white shadow-2xl rounded-xl p-6 w-[90%] max-w-md relative border-t-4"
        ...
        <div className="space-y-4 text-sm text-gray-700">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-900 font-medium text-base">
              {selectedProcedure.displayTooth}
            </span>
          </div>
