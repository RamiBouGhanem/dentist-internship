...
export const Tooth11 = ({ procedures = [], onRemove }) => (
...
export const Tooth16 = ({ procedures = [], onRemove }) => (
  <svg viewBox="0 0 100 140" className="w-full h-full">
    <path
...
export const Tooth31 = ({ procedures = [], onRemove }) => (
  <svg viewBox="0 0 100 140" className="w-full h-full">
    <path
...
export const DefaultTooth = ({ procedures = [], onRemove }) => (
  <svg viewBox="0 0 100 140" className="w-full h-full">
