...
export class PatientsService {
  ...
  //Get All patients for a certain dentist
  ...
  // Update a patient (needed for PATCH /patients/:id)
  update(id: string, updateData: Partial<Patient>) {
    return this.patientModel.findByIdAndUpdate(id, updateData, { new: true }).exec();
  }
